...
class Nav extends Component {
    ...
    search() {
        window.location = constant.BASE_URL+'/search-law?query='+this.state.search_law_query
    }
    checkLogin() {
                        ...
                        <ul className="nav navbar-nav navbar-right headerNavList">
                            <li className="headerNavListItem search-inputgroup">
                                ...
                                <div className="input-group">
                                  <input type="text" name="search_law_query" className="form-control"  placeholder="Từ khóa tìm kiếm" onChange={ this.onChangeSearchInput }/>
                                  <div className="input-group-btn">
                                   <button className="btn btn-primary" type="submit" onClick={this.search}>
                            ...
                            <li className="headerNavListItem search-inputgroup">
                                ...
                                <div className="input-group">
                                      <input type="text" name="search_lawyer_query" className="form-control" onChange={ this.onChangeSearchInput}  />
                                      <div className="input-group-btn">
                                       <button className="btn btn-primary" type="submit"  onClick={this.search}>
                                            <span className="glyphicon glyphicon-search"></span>
                                        </button>
