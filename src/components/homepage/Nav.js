        ...
        <nav className='navbar navbar-default'>
          <div className='section'>
            ...
            <div className='headerLogoContainer'>
              <a href='#'><img className='headerLogoMobile' alt='justlegal.com'
                src='https://d3autj8d5imnos.cloudfront.net/assets/layouts_images/headerLogo-5f74627a57ed4a45cabead582481b4a41067add476bc3793faa8d96eb8685135.png' /></a>
            </div>
            {this.renderView()}
          </div>
        </nav>
