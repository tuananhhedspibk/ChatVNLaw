...
let ava5 = require('../../../../assets/styles/img/avatars/5.jpg');
let ava6 = require('../../../../assets/styles/img/avatars/6.jpg');
let ava7 = require('../../../../assets/styles/img/avatars/7.jpg');
let ava8 = require('../../../../assets/styles/img/avatars/8.jpg');
          ...
          <TabPane tabId='1'>
            ...
            <div className='callout callout-warning m-0 py-3'>
              <div className='avatar float-right'>
                <img src={ava7} className='img-avatar' alt='admin@bootstrapmaster.com'/>
              </div>
            ...
            <div className='callout callout-info m-0 py-3'>
              <div className='avatar float-right'>
                <img src={ava4} className='img-avatar' alt='admin@bootstrapmaster.com'/>
              </div>
            ...
            <div className='callout callout-danger m-0 py-3'>
              ...
              <div className='avatars-stack mt-2'>
                <div className='avatar avatar-xs'>
                  <img src={ava2} className='img-avatar' alt='admin@bootstrapmaster.com'/>
                </div>
                <div className='avatar avatar-xs'>
                  <img src={ava3} className='img-avatar' alt='admin@bootstrapmaster.com'/>
                </div>
                <div className='avatar avatar-xs'>
                  <img src={ava4} className='img-avatar' alt='admin@bootstrapmaster.com'/>
                </div>
                <div className='avatar avatar-xs'>
                  <img src={ava5} className='img-avatar' alt='admin@bootstrapmaster.com'/>
                </div>
                <div className='avatar avatar-xs'>
            ...
            <div className='callout callout-primary m-0 py-3'>
              ...
              <div className='avatars-stack mt-2'>
                ...
                <div className='avatar avatar-xs'>
                  <img src={ava8} className='img-avatar' alt='admin@bootstrapmaster.com'/>
                </div>
              </div>
            </div>
            <hr className='mx-3 my-0'/>
