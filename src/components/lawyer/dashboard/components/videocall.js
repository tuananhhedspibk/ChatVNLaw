...
class VideoCall extends React.Component{
  ...
  componentDidMount(){
    ...
    properties['peer'] = this.props.peer;
    videoCall.closeRef();
  ...
  createPeer(callback){
    ...
    getStunServerList(() =>{
      ...
      do{
        counter ++;
        component.peer = new  Peer(component.props.currentUser.uid,{key: constant.PEERJS_KEY,host: 'vnlaw-peerjs.herokuapp.com',secure:true,port: 443, config: stunServer});       
      } while(!!!(component.peer.id) && counter < 10);
